...
#define errno_to_idx(code) (0 ? -1 \
  ...
  : ((code >= 50) && (code <= 57)) ? (code - 3) \
  : ((code >= 60) && (code <= 71)) ? (code - 5) \
  : ((code >= 74) && (code <= 74)) ? (code - 7) \
  : ((code >= 76) && (code <= 77)) ? (code - 8) \
  : ((code >= 79) && (code <= 88)) ? (code - 9) \
  : ((code >= 90) && (code <= 92)) ? (code - 10) \
  : ((code >= 95) && (code <= 96)) ? (code - 12) \
  : ((code >= 104) && (code <= 135)) ? (code - 19) \
  : ((code >= 138) && (code <= 139)) ? (code - 21) \
  : -1)
