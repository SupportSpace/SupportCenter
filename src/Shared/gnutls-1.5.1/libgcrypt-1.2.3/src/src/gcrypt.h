...
///////////////////////////////////////////////////////////////
#define	GCRY_THREAD_OPTION_WIN_IMPL\
static int gcry_pthread_mutex_init (void **priv)			      \
{									      \
  *priv = malloc (sizeof(CRITICAL_SECTION));\
  InitializeCriticalSection((LPCRITICAL_SECTION)(*priv)); return 0;	\
}									      \
...
static int gcry_pthread_mutex_lock (void **lock)			      \
  { EnterCriticalSection((LPCRITICAL_SECTION)(*lock)); return 0; }				      \
static int gcry_pthread_mutex_unlock (void **lock)			      \
  { LeaveCriticalSection((LPCRITICAL_SECTION)(*lock));  return 0; }				      \
									      \
static struct gcry_thread_cbs gcry_threads_winthread =			      \
...
/* Scan the S-expression for a sublist with a type (the car of the
   ...
   `NULL' when not found.  */
gcry_sexp_t gcry_sexp_find_token (const gcry_sexp_t list,
