...
function IMHandleError(e) 
{
	...
	hostObject.statNotifyLogMessage((new Date()).toLocaleTimeString()+"> IMHandlerError   "+e.firstChild.nodeName,0);
}
...
function IMLogin()
{
	...
	catch (e) 
	{
		...
		hostObject.statNotifyLogMessage((new Date()).toLocaleTimeString()+"> IMLogin   "+e.toString,0);
		return;
	}
