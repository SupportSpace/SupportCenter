========================================================================
    ACTIVE TEMPLATE LIBRARY : SSInitial Project Overview
========================================================================

AppWizard has created this SSInitial project for you to use as the starting point for
...
_SSInitial.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_SSInitial.h)
        GUID definitions                                (_SSInitial_i.c)
        A type library                                  (_SSInitial.tlb)
        Marshaling code                                 (_SSInitial_p.c and dlldata.c)
...
StdAfx.h, StdAfx.cpp
    ...
    named SSInitial.pch and a precompiled types file named StdAfx.obj.
...
SSInitialps.vcproj
	...
	dlldata.c, SSInitial_i.c and SSInitial_p.c which are required
