...
extern int __cdecl my_printf(const char *format, ...);
extern int __cdecl my_fprintf(FILE *file, const char *format, ...);
extern void __cdecl my_perror(const char *);
