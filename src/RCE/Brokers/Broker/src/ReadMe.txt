========================================================================
    ACTIVE TEMPLATE LIBRARY : Broker Project Overview
========================================================================

AppWizard has created this Broker project for you to use as the starting point for
...
_Broker.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_Broker.h)
        GUID definitions                                (_Broker_i.c)
        A type library                                  (_Broker.tlb)
        Marshaling code                                 (_Broker_p.c and dlldata.c)
...
Brokerps.vcproj
	...
	dlldata.c, Broker_i.c and Broker_p.c which are required
