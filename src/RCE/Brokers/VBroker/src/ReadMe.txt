========================================================================
    ACTIVE TEMPLATE LIBRARY : VBroker Project Overview
========================================================================

AppWizard has created this VBroker project for you to use as the starting point for
...
_VBroker.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_VBroker.h)
        GUID definitions                                (_VBroker_i.c)
        A type library                                  (_VBroker.tlb)
        Marshaling code                                 (_VBroker_p.c and dlldata.c)
...
StdAfx.h, StdAfx.cpp
    ...
    named VBroker.pch and a precompiled types file named StdAfx.obj.
...
VBrokerps.vcproj
	...
	dlldata.c, VBroker_i.c and VBroker_p.c which are required
