...
public:
	...
	virtual UINT EncodeOneRect(BYTE *source ,BYTE *dest, const RECT &rect,boost::shared_ptr<CAbstractStream> outstream/*VSocket *outConn*/);

	virtual void LastRect(boost::shared_ptr<CAbstractStream> outstream/*VSocket *outConn*/);
	virtual void AddToQueu(BYTE *source,int size,boost::shared_ptr<CAbstractStream> outstream/*VSocket *outConn*/,int must_be_zipped);
	virtual void AddToQueu2(BYTE *source,int size,boost::shared_ptr<CAbstractStream> outstream/*VSocket *outConn*/,int must_be_zipped);
	virtual void SendUltrarects(boost::shared_ptr<CAbstractStream> outstream/*VSocket *outConn*/);
