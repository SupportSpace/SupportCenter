...
public:
	...
	virtual UINT EncodeRect(BYTE *source, BYTE *source2, boost::shared_ptr<CAbstractStream> outstream/*VSocket *outConn*/, BYTE *dest, const rfb::Rect &rect);
	virtual UINT EncodeRect(BYTE *source, boost::shared_ptr<CAbstractStream> outstream /*VSocket *outConn*/, BYTE *dest, const rfb::Rect &rect);
	virtual UINT EncodeRect(BYTE *source, boost::shared_ptr<CAbstractStream> outstream /*VSocket *outConn*/, BYTE *dest, const RECT &rect); // sf@2002 - For Tight...
	...
	BOOL SendEmptyCursorShape(boost::shared_ptr<CAbstractStream> outstream /*VSocket *outConn*/);
	BOOL SendCursorShape(boost::shared_ptr<CAbstractStream> outstream /*VSocket *outConn*/, vncDesktop *desktop);
	BOOL IsXCursorSupported();

	virtual void LastRect(boost::shared_ptr<CAbstractStream> outstream/*VSocket *outConn*/); //xorzlib

protected:
	BOOL SetTranslateFunction();

	// Tight - CURSOR HANDLING
	BOOL SendXCursorShape(boost::shared_ptr<CAbstractStream> outstream /*VSocket *outConn*/, BYTE *mask, int xhot,int yhot,int width,int height);
	BOOL SendRichCursorShape(boost::shared_ptr<CAbstractStream> outstream /*VSocket *outConn*/, BYTE *mbits, BYTE *cbits, int xhot,int yhot,int width,int height);
