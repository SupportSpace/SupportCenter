...
public:
	...
	virtual UINT EncodeRect(BYTE *source, boost::shared_ptr<CAbstractStream> outstream /*VSocket *outConn*/, BYTE *dest, const RECT &rect);

	virtual void LastRect(boost::shared_ptr<CAbstractStream> outstream /*VSocket *outConn*/);
	virtual void AddToQueu(BYTE *source,int size, boost::shared_ptr<CAbstractStream> outstream /*VSocket *outConn*/);
	virtual void SendZlibHexrects(boost::shared_ptr<CAbstractStream> outstream /*VSocket *outConn*/);
...
protected:
	...
	virtual UINT EncodeHextiles8(BYTE *source, BYTE *dest,
		boost::shared_ptr<CAbstractStream> outstream /*VSocket *outConn*/, int x, int y, int w, int h);
