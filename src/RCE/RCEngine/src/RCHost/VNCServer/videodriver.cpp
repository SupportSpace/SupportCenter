...
vncVideoDriver::CreateCommunicationBuffer(int screensize)
{
	...
	if ( hFile == INVALID_HANDLE_VALUE ){
	   ...
	   Log.Add(_ERROR_, " Driver Communication service not found");
	   driver_succes=false;
	   return NULL;
    }
...
vncVideoDriver::UpdateCommunicationBuffer()
{
	...
	if ( !bRc )
	{
		...
		Log.Add(_ERROR_, "Error in DeviceIoControl");
	}
...
//		printf("Sreen Settings'%i %i %i'\n",devmode.dmPelsWidth,devmode.dmPelsHeight,devmode.dmBitsPerPel);
                         ...
                         &hKeyProfileMirror) != ERROR_SUCCESS)
        {
           ...
           Log.Add(_ERROR_, "Can not acces SYSTEM\\CurrentControlSet\\Hardware Profiles\\Current\\System\\CurrentControlSet\\Services\\vncdrv");
           return FALSE;
        }
        ...
        {
           Log.Add(_ERROR_, "Can not acces %s", deviceNum);
                          ...
                          4) != ERROR_SUCCESS)
        {
		   ...
		   Log.Add(_ERROR_, "Can not acces Attach.ToDesktop");
