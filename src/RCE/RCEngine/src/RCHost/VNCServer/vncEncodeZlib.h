...
public:
	...
	virtual UINT EncodeOneRect(BYTE *source,BYTE *source2, BYTE *dest, const RECT &rect,boost::shared_ptr<CAbstractStream> outstream /*VSocket *outConn*/);
	...
	virtual void SendZlibrects(boost::shared_ptr<CAbstractStream> outstream/*VSocket *outConn*/);
