...
protected:
	...
	UINT EncodeRectSimple (BYTE *source, boost::shared_ptr<CAbstractStream> outstream/*VSocket *outConn*/, BYTE *dest,
						   const RECT &rect);
	UINT EncodeSubrect    (BYTE *source, boost::shared_ptr<CAbstractStream> outstream/*VSocket *outConn*/, BYTE *dest,
