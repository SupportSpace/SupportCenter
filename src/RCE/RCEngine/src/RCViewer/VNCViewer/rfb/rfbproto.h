...
#define rfbSetPixelFormatClient 6
...
#define rfbStartSession 0x10	/// Start remote session
#define rfbStopSession 0x11	/// Stop remote session
#define rfbChangeModeRequest 0x12	/// Start remote session
#define rfbResetStreams 0x21	/// Reset streams
#define rfbSetViewOnly 0x24		//Set view only
#define rfbSetVisualPointer 0x23 //Set visual pointer
#define rfbSetCaptureAlphaBlend 0x25 //Set alphablend capturing
#define rfbRetrySession 0x26	//Retry broken VNC session
#define rfbSendCAD	0x27	//Send ctrl + alt + del sequence
#define rfbAliveMsg	0x28	//Alive message
#define rfbHideWallpaper	0x29	//Hide wallpaper
