// FTestQualityServer.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "FTestQualityServer.h"
...
TRY_CATCH
	...
	LoadString(hInstance, IDC_FTESTQUALITYSERVER, szWindowClass, MAX_LOADSTRING);
...
TRY_CATCH
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_FTESTQUALITYSERVER));
...
TRY_CATCH
	...
	case WM_PAINT:
		...
		QUALITYSERVER_INSTANCE.DrawFrame();
		EndPaint(hWnd, &ps);
		break;
	case WM_DESTROY:
		PostQuitMessage(0);
