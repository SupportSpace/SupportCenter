// FTestNWLGarbageServer.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "FTestNWLGarbageServer.h"
...
TRY_CATCH
	...
	LoadString(hInstance, IDC_FTESTNWLGARBAGESERVER, szWindowClass, MAX_LOADSTRING);
	...
	NWLGARBAGESERVER_INSTANCE.Start();
...
TRY_CATCH
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_FTESTNWLGARBAGESERVER));
...
TRY_CATCH
	...
	case WM_PAINT:
		...
		NWLGARBAGESERVER_INSTANCE.DrawFrame();
		EndPaint(hWnd, &ps);
		break;
	case WM_DESTROY:
		PostQuitMessage(0);
