// FrameRateTestClient.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "FTestFrameRateClient.h"
...
TRY_CATCH
	...
	LoadString(hInstance, IDC_FRAMERATETESTCLIENT, szWindowClass, MAX_LOADSTRING);
	...
	SETTINGS_INSTANCE.SetCreateFrameBitmaps(false);
	SETTINGS_INSTANCE.SetCreateControlPoints(true);
	FRAMERATECLIENT_INSTANCE;

	if(SETTINGS_INSTANCE.GetClientAutoStart())
		FRAMERATECLIENT_INSTANCE.StartViewer();
...
TRY_CATCH
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_FRAMERATETESTCLIENT));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_FRAMERATETESTCLIENT);
