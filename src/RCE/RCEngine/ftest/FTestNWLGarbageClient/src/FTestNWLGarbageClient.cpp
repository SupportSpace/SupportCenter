// FTestNWLGarbageClient.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "FTestNWLGarbageClient.h"
...
TRY_CATCH
	...
	LoadString(hInstance, IDC_FTESTNWLGARBAGECLIENT, szWindowClass, MAX_LOADSTRING);
	...
	NWLGARGAGECLIENT_INSTANCE;

	if(SETTINGS_INSTANCE.GetClientAutoStart())
		NWLGARGAGECLIENT_INSTANCE.StartViewer();
...
TRY_CATCH
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_FTESTNWLGARBAGECLIENT));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_FTESTNWLGARBAGECLIENT);
