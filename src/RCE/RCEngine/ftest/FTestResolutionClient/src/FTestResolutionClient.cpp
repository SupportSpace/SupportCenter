// FTestResolutionClient.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "FTestResolutionClient.h"
...
TRY_CATCH
	...
	LoadString(hInstance, IDC_FTESTRESOLUTIONCLIENT, szWindowClass, MAX_LOADSTRING);
	...
	RESOLUTIONCLIENT_INSTANCE;

	if(SETTINGS_INSTANCE.GetClientAutoStart())
		RESOLUTIONCLIENT_INSTANCE.StartViewer();
...
TRY_CATCH
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_FTESTRESOLUTIONCLIENT));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_FTESTRESOLUTIONCLIENT);
