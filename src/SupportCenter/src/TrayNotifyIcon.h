...
// DESCRIPTION: @{HDES}
// -----------
// CTrayNotifyIcon : Interface for a MFC class to encapsulate Shell_NotifyIcon
//					 Animation support and some other cool features added  
//---------------------------------------------------------------------------
// CHANGES LOG: @{HREV}
// -----------
// Revision: 01.00
