...
public: //API
   static UDTSOCKET socket(int af, int type = SOCK_STREAM, int protocol = 0, SOCKET win_sock = INVALID_SOCKET);
...
private:
   ...
   void open(const sockaddr* addr = NULL, SOCKET win_sock = INVALID_SOCKET);
